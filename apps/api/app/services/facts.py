...
def build_factsheet(txns: list[dict], allocations: list[dict], events: list[dict]) -> list[Fact]:
    ...
    facts.append(Fact(
        ...
        f"입금 후 {BURST_WINDOW_DAYS}일 내 생활비 지출 합 ÷ 전체 생활비 지출 합",
        len(livings),
    ))
