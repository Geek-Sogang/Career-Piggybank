...
export function EmptyState() {
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 20, paddingTop: 80 }}>
      ...
      <Text style={{ fontSize: 13.5, color: colors.sub2, fontWeight: '500', lineHeight: 22, marginTop: 8, textAlign: 'center' }}>GitHub·홈택스를 연결하면{'\n'}검증이 시작되고 심사 연결이 열려요.</Text>
      <Pressable onPress={() => actions.pushScr('connect')} style={{ backgroundColor: colors.green, borderRadius: 15, paddingVertical: 15, paddingHorizontal: 40, marginTop: 22, shadowColor: colors.green, shadowOpacity: 0.5, shadowRadius: 22, shadowOffset: { width: 0, height: 12 } }}>
