...
export function NestEgg() {
  return (
    <View style={{ gap: 14 }}>
      ...
      {/* IRP 추천 */}
      <View style={{ backgroundColor: colors.card, borderWidth: 1, borderColor: colors.green, borderRadius: 16, padding: 16, shadowColor: colors.green, shadowOpacity: 0.3, shadowRadius: 16, shadowOffset: { width: 0, height: 6 } }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: 15, fontWeight: '800', color: colors.ink }}>IRP 개인형 퇴직연금</Text>
      ...
      <Card style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 16 }} p={16}>
        <View>
          <Text style={{ fontSize: 14.5, fontWeight: '700', color: colors.ink }}>연금저축펀드</Text>
